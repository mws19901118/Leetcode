class Solution:
    def reorderedPowerOf2(self, N: int) -> bool:
        ...
        lower, upper = math.ceil(math.log2(10 ** (len(s) - 1))), math.floor(math.log2(10 ** len(s) - 1))                    #Find the lower and upper bound of power so that the power of 2 will have the same length with N.
