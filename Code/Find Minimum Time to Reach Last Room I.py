class Solution:
    def minTimeToReach(self, moveTime: List[List[int]]) -> int:
        ...
        heap = [(0, 0, 0)]                                                      #Store rooms to visit in a min heap.
        while heap:                                                             #Iterate while heap is not empty.
            t, x, y = heapq.heappop(heap)                                       #Pop heap.
            ...
            for u, v in [(x - 1, y), (x, y + 1), (x + 1, y), (x, y - 1)]:       #Traverse the neighbors of current room.
                if 0 <= u < m and 0 <= v < n and (u, v) not in visited:         #Process if neighbor is valid and unvisited.
                    visited[(u, v)] = max(t, moveTime[u][v]) + 1                #The visit time of neighbor is max(t, moveTime[u][v]) + 1.
                    heapq.heappush(heap, (visited[(u, v)], u, v))               #Push visit time of neighbor and neighbor to heap.
