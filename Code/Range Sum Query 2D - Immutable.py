class NumMatrix:
    ...
    def __init__(self, matrix: List[List[int]]):
        ...
        for i, j in product(range(m), range(n)):                                                                    #Store the sum of matrix whose top left corner is the top left corner of origin matrix and bottom right corner is every element of original matrix.
