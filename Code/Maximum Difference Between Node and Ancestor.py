...
#         self.right = right
class Solution:
    def traverse(self, root: Optional[TreeNode]) -> (int, int, int):                                                                                            #Traverse binary tree from node, return min value, max value and max difference between node and ancestor in this binary tree.
