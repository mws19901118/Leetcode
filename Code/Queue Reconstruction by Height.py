...
class Solution:
    def cmp(self, p1, p2):                                      #Customized sort: for people, first sort by height in descending order then for people in the same height, sort by number of person in the front in ascending order.
        if p1[0] > p2[0]:
            return -1
        elif p1[0] < p2[0]:
            return 1
