...
class Solution:
    def pseudoPalindromicPaths (self, root: Optional[TreeNode]) -> int:
        def dfs(root: TreeNode, path: int, masks: dict) -> int:
            ...
            return dfs(root.left, path, masks) + dfs(root.right, path, masks)               #If current node is not leaf, return the sum of DFS results of left child and right child.
        ...
        return dfs(root, 0, masks)                                                          #DFS fron root.
