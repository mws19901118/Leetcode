class Solution:
    def minOperations(self, nums: List[int]) -> int:
        ...
        index = 0                                              #Initialize the index as lower bound of binary search.
        for i, x in enumerate(distinct_nums):                  #Traverse distinct elements.
            ...
            index = bisect_right(distinct_nums, right, index)  #Binary search for the index of first element greater than right in distinct elements.
